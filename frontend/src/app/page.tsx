...
const checkpoints = [
  "Campaign operations linked to live backend contracts",
  "Citizen journeys wired to engagement and preference APIs",
  "Docker-based verification for unit, integration, and e2e flows",
];
    ...
    <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-8 px-4 py-8 sm:px-8">
      <section className="rounded-3xl bg-[linear-gradient(140deg,#0b3d5b_0%,#1d6f8a_45%,#f59e0b_100%)] p-8 text-white shadow-xl sm:p-10">
        ...
        <h1 className="mt-3 max-w-3xl text-3xl font-semibold leading-tight sm:text-5xl">
          Operational console for prevention campaign delivery
        </h1>
        <p className="mt-4 max-w-2xl text-sm text-slate-100/90 sm:text-base">
          Coordinate public health campaigns, monitor audience impact, and support citizen engagement through one
          connected platform.
        </p>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <article className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Plan campaigns, define targeting rules, preview audience volume, launch operations, and monitor live
            conversion metrics.
          </p>
          <Link
            href="/admin"
        ...
        <article className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Discover campaigns that match patient profiles, track engagement actions, and manage communication
            preferences.
          </p>
          <Link
            href="/citizen"
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-lg font-semibold text-slate-900">Operational readiness checkpoints</h2>
